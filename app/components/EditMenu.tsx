...
const EditMenu = ({setShowMenu, userReviewId, setIsEditing}: EditMenuProps) => {
    ...
    return (
        <View style={[styles.menuContainer, {width: screenWidth, height: 200}]}>
                        ...
                        style={
                            {
                                height: 40, 
                                marginVertical: 5, 
                                backgroundColor: isEditPressed ? colors.textSecondary600 : colors.textPrimary500,
                        ...
                        style={
                            {
                                height: 40, 
                                marginVertical: 5,
                                backgroundColor: isDeletePressed ? colors.textSecondary600 : colors.textPrimary500,
                                justifyContent: "center",
                            }
                        }
                    >
...
const styles = StyleSheet.create({
    menuContainer: {
        borderRadius: 12,
        backgroundColor: colors.textPrimary500,
        paddingVertical: 10,
